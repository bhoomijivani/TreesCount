...
public class TreesData {
	...
	public String getX_sp() {
		return x_sp;
	}
	public void setX_sp(String x_sp) {
		this.x_sp = x_sp;
	}
	public String getY_sp() {
		return y_sp;
	}
	...
	public String toString() {
		return "TreesData [address=" + address + ", bbl=" + bbl + ", bin="
				+ bin + ", block_id=" + block_id + ", boro_ct=" + boro_ct
				+ ", borocode=" + borocode + ", boroname=" + boroname
				+ ", brch_light=" + brch_light + ", brch_other=" + brch_other
				+ ", brch_shoe=" + brch_shoe + ", cb_num=" + cb_num
				+ ", census_tract=" + census_tract + ", cncldist=" + cncldist
				+ ", council_district=" + council_district + ", created_at="
				+ created_at + ", curb_loc=" + curb_loc + ", guards=" + guards
				+ ", health=" + health + ", latitude=" + latitude
				+ ", longitude=" + longitude + ", nta=" + nta + ", nta_name="
				+ nta_name + ", problems=" + problems + ", root_grate="
				+ root_grate + ", root_other=" + root_other + ", root_stone="
				+ root_stone + ", sidewalk=" + sidewalk + ", spc_common="
				+ spc_common + ", spc_latin=" + spc_latin + ", st_assem="
				+ st_assem + ", st_senate=" + st_senate + ", state=" + state
				+ ", status=" + status + ", steward=" + steward
				+ ", stump_diam=" + stump_diam + ", tree_dbh=" + tree_dbh
				+ ", tree_id=" + tree_id + ", trnk_light=" + trnk_light
				+ ", trnk_other=" + trnk_other + ", trunk_wire=" + trunk_wire
				+ ", user_type=" + user_type + ", x_sp=" + x_sp + ", y_sp="
				+ y_sp + ", zip_city=" + zip_city + ", zipcode=" + zipcode
				+ "]";
	}
